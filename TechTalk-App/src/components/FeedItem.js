      ...
      >
        ...
        <View style={styles.containeruser}>
            ...
            <StyledText fontWeight='normal' fontSize='body'>
                <Image style={styles.performance}
                    source={{
        ...
        <View style={styles.containericons}>
            <Image style={styles.flag}
                source={{ 
                    uri: (conectUser.country ?  conectUser.country : "https://t4.ftcdn.net/jpg/01/06/07/43/240_F_106074343_rDq3QWNlgK6lQWI5BbgwoY5AM5D3qIDY.jpg")
